...
export function MatchCard({
  ...
  return (
    <article className="rounded-md border border-brand-towerMid/25 bg-white p-4 shadow-insetLine transition hover:border-brand-electric/35 hover:shadow-panel">
      ...
      <div className="my-4 grid w-full grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-3 text-left">
        ...
        <button
          ...
          className="rounded-md bg-brand-navy px-3 py-2 text-sm font-black text-white transition hover:bg-brand-electric"
      ...
      <div className="grid gap-2 rounded-md bg-brand-wash p-3 text-xs font-bold text-brand-muted sm:grid-cols-2">
...
function TeamName({
  ...
  return (
    <button
      ...
      className={`flex min-w-0 items-center gap-2 rounded px-1 py-1 hover:bg-brand-electric/10 hover:text-brand-electric ${
